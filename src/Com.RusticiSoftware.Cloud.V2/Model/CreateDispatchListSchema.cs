...
namespace Com.RusticiSoftware.Cloud.V2.Model
{
    ...
    public partial class CreateDispatchListSchema :  IEquatable<CreateDispatchListSchema>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CreateDispatchListSchema);
        }

        /// <summary>
        /// Returns true if CreateDispatchListSchema instances are equal
        /// </summary>
        /// <param name="other">Instance of CreateDispatchListSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateDispatchListSchema other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
