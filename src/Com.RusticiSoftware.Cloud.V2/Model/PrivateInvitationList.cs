...
namespace Com.RusticiSoftware.Cloud.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PrivateInvitationList : PaginatedList,  IEquatable<PrivateInvitationList>, IValidatableObject
    {
        /// <summary>
        ...
        public PrivateInvitationList(List<PrivateInvitationSchema> invitations = default(List<PrivateInvitationSchema>), string more = default(string)) : base(more)
        {
