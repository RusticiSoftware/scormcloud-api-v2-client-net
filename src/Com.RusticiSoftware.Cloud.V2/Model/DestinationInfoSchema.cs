...
namespace Com.RusticiSoftware.Cloud.V2.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DestinationInfoSchema :  IEquatable<DestinationInfoSchema>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DestinationInfoSchema" /> class.
        /// </summary>
        /// <param name="name">The destination&#39;s name..</param>
        /// <param name="dispatchCount">dispatchCount.</param>
        ...
        public DestinationInfoSchema(string name = default(string), int? dispatchCount = default(int?), DateTime? updated = default(DateTime?), DateTime? created = default(DateTime?), List<string> tags = default(List<string>), string email = default(string), string notes = default(string), LaunchAuthSchema launchAuth = default(LaunchAuthSchema), Lti13PlatformConfigurationSchema lti13Data = default(Lti13PlatformConfigurationSchema))
        {
            this.Name = name;
        ...
        /// <summary>
        /// Gets or Sets DispatchCount
        /// </summary>
        [DataMember(Name="dispatchCount", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  DispatchCount: ").Append(DispatchCount).Append("\n");
        ...
        {
            return this.Equals(input as DestinationInfoSchema);
        }

        /// <summary>
        /// Returns true if DestinationInfoSchema instances are equal
        /// </summary>
        /// <param name="input">Instance of DestinationInfoSchema to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DestinationInfoSchema input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.DispatchCount == input.DispatchCount ||
                    (this.DispatchCount != null &&
                    this.DispatchCount.Equals(input.DispatchCount))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.DispatchCount != null)
                    hashCode = hashCode * 59 + this.DispatchCount.GetHashCode();
