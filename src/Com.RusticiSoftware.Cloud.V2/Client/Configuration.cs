...
namespace Com.RusticiSoftware.Cloud.V2.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            UserAgent = "Swagger-Codegen/1.0.0-beta/csharp";
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "Swagger-Codegen/1.0.0-beta/csharp"
        ...
        public static String ToDebugReport()
        {
            ...
            report += "    Version of the API: 2.0 beta\n";
            report += "    SDK Package Version: 1.0.0-beta\n";
