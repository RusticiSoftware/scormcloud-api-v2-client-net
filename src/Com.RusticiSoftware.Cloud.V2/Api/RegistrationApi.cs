...
namespace Com.RusticiSoftware.Cloud.V2.Api
{
    ...
    public partial class RegistrationApi : IRegistrationApi
    {
        ...
        /// <param name="registrationId">id for this registration</param>
        /// <returns></returns>
        public void DeleteRegistrationsGlobalData (string registrationId)
        {
        ...
        /// <param name="registrationId">id for this registration</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> DeleteRegistrationsGlobalDataWithHttpInfo (string registrationId)
        {
            // verify the required parameter 'registrationId' is set
            if (registrationId == null)
                throw new ApiException(400, "Missing required parameter 'registrationId' when calling RegistrationApi->DeleteRegistrationsGlobalData");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("DeleteRegistrationsGlobalData", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="registrationId">id for this registration</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task DeleteRegistrationsGlobalDataAsync (string registrationId)
        {
             await DeleteRegistrationsGlobalDataAsyncWithHttpInfo(registrationId);
        ...
        /// <param name="registrationId">id for this registration</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> DeleteRegistrationsGlobalDataAsyncWithHttpInfo (string registrationId)
        {
            // verify the required parameter 'registrationId' is set
            if (registrationId == null)
                throw new ApiException(400, "Missing required parameter 'registrationId' when calling RegistrationApi->DeleteRegistrationsGlobalData");
        ...
        /// <param name="launchLinkRequest"></param>
        /// <returns>LaunchLinkSchema</returns>
        public LaunchLinkSchema GetRegistrationLaunchLink (string registrationId, LaunchLinkRequestSchema launchLinkRequest)
        {
             ApiResponse<LaunchLinkSchema> localVarResponse = GetRegistrationLaunchLinkWithHttpInfo(registrationId, launchLinkRequest);
             return localVarResponse.Data;
        }
        ...
        /// <param name="launchLinkRequest"></param>
        /// <returns>ApiResponse of LaunchLinkSchema</returns>
        public ApiResponse< LaunchLinkSchema > GetRegistrationLaunchLinkWithHttpInfo (string registrationId, LaunchLinkRequestSchema launchLinkRequest)
        {
            // verify the required parameter 'registrationId' is set
            if (registrationId == null)
                throw new ApiException(400, "Missing required parameter 'registrationId' when calling RegistrationApi->GetRegistrationLaunchLink");
            // verify the required parameter 'launchLinkRequest' is set
            if (launchLinkRequest == null)
                throw new ApiException(400, "Missing required parameter 'launchLinkRequest' when calling RegistrationApi->GetRegistrationLaunchLink");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetRegistrationLaunchLink", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="launchLinkRequest"></param>
        /// <returns>Task of LaunchLinkSchema</returns>
        public async System.Threading.Tasks.Task<LaunchLinkSchema> GetRegistrationLaunchLinkAsync (string registrationId, LaunchLinkRequestSchema launchLinkRequest)
        {
             ApiResponse<LaunchLinkSchema> localVarResponse = await GetRegistrationLaunchLinkAsyncWithHttpInfo(registrationId, launchLinkRequest);
             return localVarResponse.Data;
        ...
        /// <param name="launchLinkRequest"></param>
        /// <returns>Task of ApiResponse (LaunchLinkSchema)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<LaunchLinkSchema>> GetRegistrationLaunchLinkAsyncWithHttpInfo (string registrationId, LaunchLinkRequestSchema launchLinkRequest)
        {
            // verify the required parameter 'registrationId' is set
            if (registrationId == null)
                throw new ApiException(400, "Missing required parameter 'registrationId' when calling RegistrationApi->GetRegistrationLaunchLink");
        ...
        /// <param name="registrationId">id for this registration</param>
        /// <returns></returns>
        public void RegistrationExists (string registrationId)
        {
        ...
        /// <param name="registrationId">id for this registration</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public ApiResponse<Object> RegistrationExistsWithHttpInfo (string registrationId)
        {
            // verify the required parameter 'registrationId' is set
            if (registrationId == null)
                throw new ApiException(400, "Missing required parameter 'registrationId' when calling RegistrationApi->RegistrationExists");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("RegistrationExists", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="registrationId">id for this registration</param>
        /// <returns>Task of void</returns>
        public async System.Threading.Tasks.Task RegistrationExistsAsync (string registrationId)
        {
             await RegistrationExistsAsyncWithHttpInfo(registrationId);
        ...
        /// <param name="registrationId">id for this registration</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Object>> RegistrationExistsAsyncWithHttpInfo (string registrationId)
        {
            // verify the required parameter 'registrationId' is set
            if (registrationId == null)
                throw new ApiException(400, "Missing required parameter 'registrationId' when calling RegistrationApi->RegistrationExists");
