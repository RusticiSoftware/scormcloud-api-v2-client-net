...
namespace Com.RusticiSoftware.Cloud.V2.Api
{
    ...
    public partial class LearnerApi : ILearnerApi
    {
        ...
        /// <returns></returns>
        public LearnerApi(Configuration configuration = null)
        {
        ...
        public ApiResponse<Object> DeleteAllLearnerDataWithHttpInfo (string learnerId, string userEmail)
        {
            ...
            if (userEmail != null) localVarQueryParams.Add("userEmail", Configuration.ApiClient.ParameterToString(userEmail)); // query parameter
