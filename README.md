...
## Documentation for Models
 ...
 - [Model.CourseTagsBatchSchema](docs/CourseTagsBatchSchema.md)
 ...
 - [Model.RegistrationTagsBatchSchema](docs/RegistrationTagsBatchSchema.md)
 ...
 - [Model.SettingValidValue](docs/SettingValidValue.md)
 ...
 - [Model.TagListSchema](docs/TagListSchema.md)
 - [Model.TagPostSchema](docs/TagPostSchema.md)
 - [Model.TitleSchema](docs/TitleSchema.md)
 - [Model.TokenRequestSchema](docs/TokenRequestSchema.md)
 - [Model.XapiAccount](docs/XapiAccount.md)
 - [Model.XapiActivity](docs/XapiActivity.md)
 - [Model.XapiActivityDefinition](docs/XapiActivityDefinition.md)
 - [Model.XapiAgentGroup](docs/XapiAgentGroup.md)
 - [Model.XapiAttachment](docs/XapiAttachment.md)
 - [Model.XapiContext](docs/XapiContext.md)
 - [Model.XapiContextActivity](docs/XapiContextActivity.md)
 - [Model.XapiInteractionComponent](docs/XapiInteractionComponent.md)
 - [Model.XapiResult](docs/XapiResult.md)
 - [Model.XapiScore](docs/XapiScore.md)
 - [Model.XapiStatement](docs/XapiStatement.md)
 - [Model.XapiStatementReference](docs/XapiStatementReference.md)
 - [Model.XapiStatementResult](docs/XapiStatementResult.md)
 - [Model.XapiVerb](docs/XapiVerb.md)


<a name="documentation-for-authorization"></a>
## Documentation for Authorization

<a name="APP_MANAGEMENT"></a>
### APP_MANAGEMENT
